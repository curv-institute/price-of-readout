...
the masking signature is \emph{reproduced at scale}. Table~\ref{tab:e3-cells} gives the
...
a sharp onset between 4 and 3 bits (Table~\ref{tab:pythia-quant}). Refitting the
...
(Table~\ref{tab:pythia-ood}; Pearson $0.93$, Spearman $0.86$, $n=8$,
